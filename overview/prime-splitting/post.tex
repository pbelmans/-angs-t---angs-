...
Let~${q = \frac{a}{b} = \frac{p_1^{e_1}\ldots p_r^{e_r}}{q_1^{f_1}\ldots q_s^{l_s}}}$ and~${p}$ a prime number such that~${v_p(q) = 0}$. We have that~${\bar{a} \cdot \bar{b}^{-1} \in \mathbb{F}_p^*}$, and the covering map sends 
\begin{equation}
